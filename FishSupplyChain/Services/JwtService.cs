...
namespace FishSupplyChain.Services
{
    ...
    {
        public (string AccessToken, RefreshTokenEntity RefreshToken) GenerateTokens (CreateTokenForUserDto userInfo, string? createdByIp)
        {
        ...
        public string RenewAccessToken(CreateTokenForUserDto userInfo)
        {
            string? issuer = configuration["JWT-Config:Issuer"];
            string? audience = configuration["JWT-Config:Audience"];
            string? key = configuration["JWT-Config:Key"];
